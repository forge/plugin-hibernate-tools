   ...
   public void testH2() throws Exception {
       ...
       Connection conn = 
    		   DriverManager.getConnection(
    				   "jdbc:h2:tcp://localhost/mem:test;USER=foo;PASSWORD=bar");
	...
	public void test() throws Exception {
		...
		getShell().execute(
				...
				" --pathToDriverJar " + resolveHsqlDriverJarPath() +
	...
	private String resolveH2DriverJarPath() {
		File file = MavenArtifactResolver.resolve("com.h2database", "h2", "1.3.167");
		return file == null ? "" : file.getAbsolutePath();
	}
